...
source.exclude_dirs = tests,bin,.pytest_cache,__pycache__,.git,.github,.venv,cache,.idea,.vscode
...
requirements = python3,kivy==2.3.0,https://github.com/kivymd/KivyMD/archive/master.zip,materialyoucolor,asynckivy,asyncgui,aiohttp,aiosqlite,httpx,pydantic,cryptography,pillow,plyer,beautifulsoup4,certifi,openssl,sqlite3
