...
class DialogsRepository:
    ...
    async def fetch_dialogs(self, offset: int = 0, count: int = 30, filter: Optional[str] = None) -> List[VKDialogItem]:
        """Fetches dialogs from VK API, caches them in SQLite, and returns items."""
        ...
        for item in items:
            ...
            d_item = VKDialogItem(
                ...
                last_message_time=last_msg.get("date", 0),
